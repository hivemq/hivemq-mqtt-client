...
public class Mqtt3RxClientViewBuilder extends MqttRxClientBuilderBase<Mqtt3RxClientViewBuilder>
    ...
    private @NotNull MqttClientConfig buildClientConfig() {
        return new MqttClientConfig(MqttVersion.MQTT_3_1_1, identifier, getServerAddress(), executorConfig, sslConfig,
                webSocketConfig, MqttClientAdvancedConfig.DEFAULT, buildDisconnectedListeners());
    }
}
