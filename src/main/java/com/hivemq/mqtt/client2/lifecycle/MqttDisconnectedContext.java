...
import com.hivemq.mqtt.client2.MqttClientConfig;
...
public interface MqttDisconnectedContext {
     ...
     * This can be:
     * <ul>
     *   <li>{@link com.hivemq.mqtt.client2.exceptions.ConnectionFailedException ConnectionFailedException} if a connect
     *     attempt failed
     *   <li>{@link com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3ConnAckException Mqtt3ConnAckException} or {@link
     *     com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5ConnAckException Mqtt5ConnAckException} (depending on the MQTT
     *     version of the client) if the ConnAck message contained an error code, which means that the connect was
     *     rejected
     *   <li>{@link com.hivemq.mqtt.client2.exceptions.ConnectionClosedException ConnectionClosedException} if the
     ...
     *   <li>{@link com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3DisconnectException Mqtt3DisconnectException} or {@link
     *     com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5DisconnectException Mqtt5DisconnectException} (depending on the
