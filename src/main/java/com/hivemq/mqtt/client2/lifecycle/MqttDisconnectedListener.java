...
public interface MqttDisconnectedListener<C extends MqttDisconnectedContext> {
     ...
     *     connection failed. The client state will still be {@link com.hivemq.mqtt.client2.MqttClientState#CONNECTED
     *     CONNECTED} and the {@link com.hivemq.mqtt.client2.MqttClientConnectionConfig MqttClientConnectionConfig} will
     *     still be present.
     *   <li>A connect attempt by the user failed. The client state will still be
     *     {@link com.hivemq.mqtt.client2.MqttClientState#CONNECTING CONNECTING}.
     *   <li>A reconnect attempt by the client failed. The client state will still be
     *     {@link com.hivemq.mqtt.client2.MqttClientState#CONNECTING_RECONNECT CONNECTING_RECONNECT}.
     * </ul>
     * The client state will be updated after all {@link MqttDisconnectedListener}s
     * are called to
     * <ul>
     *   <li>{@link com.hivemq.mqtt.client2.MqttClientState#DISCONNECTED DISCONNECTED} or
     *   <li>{@link com.hivemq.mqtt.client2.MqttClientState#DISCONNECTED_RECONNECT DISCONNECTED_RECONNECT} if the client
