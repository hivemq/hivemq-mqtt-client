...
package com.hivemq.mqtt.client2.mqtt3.message.subscribe;
...
public interface Mqtt3SubscribeBuilder extends Mqtt3SubscribeBuilderBase<Mqtt3SubscribeBuilder.Complete> {
    ...
    /**
     * Builder for a {@link Mqtt3Subscribe} that is applied to a parent
     * {@link com.hivemq.mqtt.client2.mqtt3.Mqtt3Client Mqtt3Client} which then sends the Subscribe message.
     *
    ...
    /**
     * Builder for a {@link Mqtt3Subscribe} and additional arguments that are applied to a parent
     * {@link com.hivemq.mqtt.client2.mqtt3.Mqtt3Client Mqtt3Client} <code>subscribePublishes</code> call.
     *
     * @param <P> the type of the result when the built {@link Mqtt3Subscribe} is applied to the parent.
     * @since 1.2
     */
    ...
    interface Publishes<P> extends Mqtt3SubscribeBuilderBase<Publishes.Complete<P>> {
        ...
        /**
         * Builder for additional arguments alongside the {@link Mqtt3Subscribe} that are applied to a parent
         * {@link com.hivemq.mqtt.client2.mqtt3.Mqtt3Client Mqtt3Client} <code>subscribePublishes</code> call.
         *
         * @param <P> the type of the result when the built {@link Mqtt3Subscribe} is applied to the parent.
         */
