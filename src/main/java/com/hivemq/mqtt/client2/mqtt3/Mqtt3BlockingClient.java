...
import com.hivemq.mqtt.client2.mqtt3.message.publish.Mqtt3PublishBuilder;
...
public interface Mqtt3BlockingClient extends Mqtt3Client {
     ...
     * @throws com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3ConnAckException wrapping the ConnAck message if it
     ...
     * @throws com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3SubAckException wrapping the SubAck message if it contains
    ...
    interface Publishes extends AutoCloseable {
         ...
         *                              received.
         */
        @NotNull Optional<Mqtt3Publish> receive(long timeout, @NotNull TimeUnit timeUnit) throws InterruptedException;
