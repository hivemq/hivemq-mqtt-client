...
public interface Mqtt3ClientConfig extends MqttClientConfig {
     ...
     * {@link com.hivemq.mqtt.client2.mqtt3.message.connect.Mqtt3Connect#getSimpleAuth() Mqtt3Connect.simpleAuth} is not
     * set during connect.
     * <p>
     ...
     * {@link com.hivemq.mqtt.client2.mqtt3.message.connect.Mqtt3Connect#getSimpleAuth() Mqtt3Connect.simpleAuth}
     * instead.
     *
     ...
     * <p>
     * It is used as default if
     * {@link com.hivemq.mqtt.client2.mqtt3.message.connect.Mqtt3Connect#getWillPublish() Mqtt3Connect.willPublish} is
     ...
     * {@link com.hivemq.mqtt.client2.mqtt3.message.connect.Mqtt3Connect#getWillPublish() Mqtt3Connect.willPublish}
     * instead.
     *
