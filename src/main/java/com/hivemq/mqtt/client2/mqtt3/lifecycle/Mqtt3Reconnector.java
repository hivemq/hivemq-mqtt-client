...
/**
 * A {@link MqttReconnector} with methods specific to an {@link com.hivemq.mqtt.client2.mqtt3.Mqtt3Client Mqtt3Client}.
 *
 * @author Silvio Giebl
 * @since 1.1
 */
...
public interface Mqtt3Reconnector extends MqttReconnector {
     ...
     * <p>
     * If the {@link #connect(Mqtt3Connect)} method has not been called before (including previous
     * {@link com.hivemq.mqtt.client2.lifecycle.MqttDisconnectedListener MqttDisconnectedListener}s) it will be the
     * Connect message that is reconstructed from the
     * {@link com.hivemq.mqtt.client2.mqtt3.Mqtt3ClientConnectionConfig Mqtt3ClientConnectionConfig} or the Connect
