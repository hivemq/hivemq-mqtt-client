...
import com.hivemq.mqtt.client2.mqtt3.message.subscribe.Mqtt3SubscribeBuilderBase;
...
public interface Mqtt3AsyncClient extends Mqtt3Client {
     ...
     *             successfully),
     *           <li>completes exceptionally with a {@link com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3ConnAckException
     ...
     *           <li>completes exceptionally with a {@link com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3SubAckException
