...
import com.hivemq.mqtt.client2.MqttClientConnectionConfig;
...
public interface Mqtt5ClientConnectionConfig extends MqttClientConnectionConfig {
    ...
    interface RestrictionsForServer {
         ...
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#getReceiveMaximum
         ...
         * <p>
         * The value is determined by
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#getMaximumPacketSize
         ...
         * <p>
         * The value is determined by
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#getTopicAliasMaximum
         ...
         * <p>
         * The value is determined by
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#isRequestProblemInformation
         ...
         * <p>
         * The value is determined by
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#isRequestResponseInformation
    ...
    interface RestrictionsForClient {
         ...
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#getSendMaximum
         * Mqtt5ConnectRestrictions#getSendMaximum()} and
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnAckRestrictions#getReceiveMaximum()
         ...
         * <p>
         * The value is determined by the minimum of
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#getSendMaximumPacketSize
         * Mqtt5ConnectRestrictions#getSendMaximumPacketSize()} and
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnAckRestrictions#getMaximumPacketSize()
         ...
         * <p>
         * The value is determined by the minimum of
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectRestrictions#getSendTopicAliasMaximum
         * Mqtt5ConnectRestrictions#getSendTopicAliasMaximum()} and
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnAckRestrictions#getTopicAliasMaximum()
         ...
         * <p>
         * The value is determined by
         * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnAckRestrictions#getMaximumQos()
