...
public interface Mqtt5Connect extends Mqtt5Message {
    ...
    /**
     * @return the session expiry interval in seconds the client wants to use. The default is
     *         {@link #DEFAULT_SESSION_EXPIRY_INTERVAL}. If it is {@link #NO_SESSION_EXPIRY} the session does not
     *         expire.
     */
