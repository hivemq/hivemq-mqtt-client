...
import com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5ConnectBuilder;
import com.hivemq.mqtt.client2.mqtt5.message.disconnect.Mqtt5Disconnect;
import com.hivemq.mqtt.client2.mqtt5.message.disconnect.Mqtt5DisconnectBuilder;
import com.hivemq.mqtt.client2.mqtt5.message.publish.Mqtt5Publish;
import com.hivemq.mqtt.client2.mqtt5.message.publish.Mqtt5PublishBuilder;
...
import com.hivemq.mqtt.client2.mqtt5.message.subscribe.Mqtt5SubscribeBuilder;
...
public interface Mqtt5BlockingClient extends Mqtt5Client {
     ...
     * @throws com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5ConnAckException wrapping the ConnAck message if it
     ...
     * @throws com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5SubAckException wrapping the SubAck message if it contains
     ...
     * @throws com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5UnsubAckException wrapping the UnsubAck message if it
     ...
     * @throws com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5PubAckException wrapping the corresponding PubAck message
     *                                                                       if it contains an Error Code.
     * @throws com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5PubRecException wrapping the corresponding PubRec message
     *                                                                       if it contains an Error Code.
     */
     ...
     *
     * @throws com.hivemq.mqtt.client2.mqtt5.exceptions.Mqtt5AuthException wrapping the Auth message with the Error Code
