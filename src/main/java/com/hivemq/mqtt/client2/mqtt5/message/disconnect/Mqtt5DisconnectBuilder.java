...
package com.hivemq.mqtt.client2.mqtt5.message.disconnect;
...
public interface Mqtt5DisconnectBuilder extends Mqtt5DisconnectBuilderBase<Mqtt5DisconnectBuilder> {
    ...
    /**
     * Builder for a {@link Mqtt5Disconnect} that is applied to a parent
     * {@link com.hivemq.mqtt.client2.mqtt5.Mqtt5Client} which then sends the Disconnect message.
     *
    ...
    /**
     * Builder for a {@link Mqtt5Disconnect} that is applied to a parent
     * {@link com.hivemq.mqtt.client2.mqtt5.Mqtt5Client} which then sends the Disconnect message without returning a
     * result.
     */
    @ApiStatus.NonExtendable
