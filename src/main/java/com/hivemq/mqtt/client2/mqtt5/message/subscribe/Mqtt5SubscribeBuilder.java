...
package com.hivemq.mqtt.client2.mqtt5.message.subscribe;
...
public interface Mqtt5SubscribeBuilder extends Mqtt5SubscribeBuilderBase<Mqtt5SubscribeBuilder.Complete> {
    ...
    /**
     * Builder for a {@link Mqtt5Subscribe} that is applied to a parent
     * {@link com.hivemq.mqtt.client2.mqtt5.Mqtt5Client Mqtt5Client} which then sends the Subscribe message.
     *
    ...
    /**
     * Builder for a {@link Mqtt5Subscribe} and additional arguments that are applied to a parent
     * {@link com.hivemq.mqtt.client2.mqtt5.Mqtt5Client Mqtt5Client} <code>subscribePublishes</code> call.
     *
     * @param <P> the type of the result when the built {@link Mqtt5Subscribe} is applied to the parent.
     * @since 1.2
     */
    ...
    interface Publishes<P> extends Mqtt5SubscribeBuilderBase<Publishes.Complete<P>> {
        ...
        /**
         * Builder for additional arguments alongside the {@link Mqtt5Subscribe} that are applied to a parent
         * {@link com.hivemq.mqtt.client2.mqtt5.Mqtt5Client Mqtt5Client} <code>subscribePublishes</code> call.
         *
         * @param <P> the type of the result when the built {@link Mqtt5Subscribe} is applied to the parent.
         */
