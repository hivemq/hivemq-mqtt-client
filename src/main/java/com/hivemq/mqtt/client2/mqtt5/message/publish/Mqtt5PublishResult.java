...
package com.hivemq.mqtt.client2.mqtt5.message.publish;
 ...
 * {@link com.hivemq.mqtt.client2.datatypes.MqttQos QoS} level).
 *
 * @author Silvio Giebl
 * @since 1.0
 */
...
public interface Mqtt5PublishResult {
     ...
     * {@link com.hivemq.mqtt.client2.datatypes.MqttQos#AT_LEAST_ONCE QoS level 1} sent by the client.
     * <p>
    ...
    /**
     * Result for a {@link Mqtt5Publish MQTT 5 Publish message} with
     * {@link com.hivemq.mqtt.client2.datatypes.MqttQos#EXACTLY_ONCE QoS level 2} sent by the client.
     * <p>
