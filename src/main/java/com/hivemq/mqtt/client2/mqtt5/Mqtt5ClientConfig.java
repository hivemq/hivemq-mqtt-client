...
public interface Mqtt5ClientConfig extends MqttClientConfig {
     ...
     * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5Connect#getSimpleAuth() Mqtt5Connect.simpleAuth} is not
     * set during connect.
     * <p>
     ...
     * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5Connect#getSimpleAuth() Mqtt5Connect.simpleAuth}
     * instead.
     *
     ...
     * <p>
     * It is used as default if
     * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5Connect#getEnhancedAuthMechanism()
     ...
     * <p>
     * It is used as default if
     * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5Connect#getWillPublish() Mqtt5Connect.willPublish} is
     ...
     * {@link com.hivemq.mqtt.client2.mqtt5.message.connect.Mqtt5Connect#getWillPublish() Mqtt5Connect.willPublish}
     * instead.
     *
