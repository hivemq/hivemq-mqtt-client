...
package com.hivemq.mqtt.client2.libs.reactivestreams;
...
public interface PublisherWithSingle<T, S> extends Publisher<T> {
     ...
     *
     * @param subscriber the {@link WithSingleSubscriber} that will consume signals from this
     *                   {@link PublisherWithSingle}.
