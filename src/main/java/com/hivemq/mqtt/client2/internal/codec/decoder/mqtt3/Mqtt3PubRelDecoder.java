...
import com.hivemq.mqtt.client2.internal.message.publish.mqtt3.Mqtt3PubRelView;
...
public class Mqtt3PubRelDecoder implements MqttMessageDecoder {
    ...
    public static final @NotNull Mqtt3PubRelDecoder INSTANCE = new Mqtt3PubRelDecoder();

    private static final int FLAGS = 0b0010;
    private static final int REMAINING_LENGTH = 2;

    private Mqtt3PubRelDecoder() {}
