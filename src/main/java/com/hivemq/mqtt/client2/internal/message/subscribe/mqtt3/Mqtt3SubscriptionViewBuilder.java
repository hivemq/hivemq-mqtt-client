...
package com.hivemq.mqtt.client2.internal.message.subscribe.mqtt3;

import com.hivemq.mqtt.client2.datatypes.MqttQos;
import com.hivemq.mqtt.client2.datatypes.MqttTopicFilter;
import com.hivemq.mqtt.client2.internal.datatypes.MqttTopicFilterImpl;
import com.hivemq.mqtt.client2.internal.datatypes.MqttTopicFilterImplBuilder;
...
import com.hivemq.mqtt.client2.mqtt3.message.subscribe.Mqtt3Subscription;
import com.hivemq.mqtt.client2.mqtt3.message.subscribe.Mqtt3SubscriptionBuilder;
...
public abstract class Mqtt3SubscriptionViewBuilder<B extends Mqtt3SubscriptionViewBuilder<B>> {
    ...
    private @NotNull MqttQos maxQos = Mqtt3SubscriptionView.DEFAULT_MAX_QOS;
