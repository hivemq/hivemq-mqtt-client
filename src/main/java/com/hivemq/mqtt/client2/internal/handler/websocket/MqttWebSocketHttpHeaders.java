...
public class MqttWebSocketHttpHeaders extends ChannelDuplexHandler {
    ...
    public static final @NotNull String HTTP_HEADERS = "http.headers";
    private final @NotNull Map<String, String> httpHeaders;

    public MqttWebSocketHttpHeaders(final @NotNull Map<@NotNull String, @NotNull String> httpHeaders) {
