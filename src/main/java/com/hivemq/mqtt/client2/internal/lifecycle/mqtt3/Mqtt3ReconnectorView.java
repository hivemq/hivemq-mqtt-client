...
import com.hivemq.mqtt.client2.internal.MqttTransportConfigImplBuilder;
...
import com.hivemq.mqtt.client2.mqtt3.lifecycle.Mqtt3Reconnector;
...
public class Mqtt3ReconnectorView implements Mqtt3Reconnector {
    ...
    @Override
    public @NotNull Mqtt3ReconnectorView resubscribeIfSessionPresent(final boolean resubscribeIfSessionPresent) {
