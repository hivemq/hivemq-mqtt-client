 ...
 */
@Singleton
public class Mqtt3PubAckEncoder implements Mqtt3MessageEncoder<Mqtt3PubAckInternal> {
    ...
    @Override
    public void encode(
            @NotNull final Mqtt3PubAckInternal pubAckInternal, @NotNull final Channel channel,
    ...
    private void encodeVariableHeader(@NotNull final Mqtt3PubAckInternal pubAckInternal, @NotNull final ByteBuf out) {
        out.writeShort(pubAckInternal.getPacketId());
    }
}
