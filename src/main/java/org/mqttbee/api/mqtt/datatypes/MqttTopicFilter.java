 ...
 *
 * <p>A Topic Filter has the restrictions from {@link MqttUTF8String}, must be at least one
 * character long, may contain one {@link #MULTI_LEVEL_WILDCARD} at the end and may contain multiple
 * {@link #SINGLE_LEVEL_WILDCARD}s.
 *
 * @author Silvio Giebl
 */
@DoNotImplement
