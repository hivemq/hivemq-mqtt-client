...
public interface Mqtt5ConnectRestrictions {
    ...
    /**
     * The default maximum amount of not acknowledged publishes with QoS 1 or 2 the client accepts
     * concurrently.
     */
    ...
    /**
     * The default maximum packet size the client accepts from the server which indicates that the
    ...
    /**
     * @return the maximum amount of not acknowledged publishes with QoS 1 or 2 the client accepts
     *     concurrently. The default is {@link #DEFAULT_RECEIVE_MAXIMUM}.
     */
    int getReceiveMaximum();

    /**
     * @return the maximum amount of topic aliases the client accepts from the server. The default
