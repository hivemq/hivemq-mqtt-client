...
public interface Mqtt5ConnAckRestrictions {
    ...
    /**
     * The default maximum amount of not acknowledged publishes with QoS 1 or 2 the server accepts
     * concurrently.
     */
    ...
    /**
     * The default maximum packet size the server accepts from the client which indicates that the
     * packet size is not limited beyond the restrictions of the encoding.
     */
    ...
    /**
     * @return the maximum amount of not acknowledged publishes with QoS 1 or 2 the server accepts
     *     concurrently. The default is {@link #DEFAULT_RECEIVE_MAXIMUM}.
     */
    int getReceiveMaximum();

    /**
     * @return the maximum amount of topic aliases the server accepts from the client. The default
     *     is {@link #DEFAULT_TOPIC_ALIAS_MAXIMUM}.
     */
    ...
    /**
     * @return the maximum QoS the server accepts from the client. The default is {@link
     *     #DEFAULT_MAXIMUM_QOS}.
     */
    MqttQoS getMaximumQoS();

    /**
     * @return whether the server accepts retained messages. The default is {@link
