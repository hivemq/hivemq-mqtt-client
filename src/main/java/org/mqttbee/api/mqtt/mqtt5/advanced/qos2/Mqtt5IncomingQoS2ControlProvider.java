...
public interface Mqtt5IncomingQoS2ControlProvider {
     ...
     *
     * <p>This method must not block and just add some properties to the outgoing PUBREC message.
     *
     ...
     *
     * <p>This method must not block and just add some properties to the outgoing PUBCOMP message.
     *
