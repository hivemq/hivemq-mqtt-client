...
public class Mqtt5ConnectBuilder {
  ...
  @NotNull
  public Mqtt5ConnectBuilder withResponseInformationRequested(
  ...
  @NotNull
  public Mqtt5ConnectBuilder withProblemInformationRequested(
  ...
  @NotNull
  public Mqtt5ConnectBuilder withRestrictions(
      @NotNull final Mqtt5ConnectRestrictions restrictions) {
    this.restrictions =
        MustNotBeImplementedUtil.checkNotImplemented(restrictions, MqttConnectRestrictions.class);
    return this;
  }
  ...
  public Mqtt5ConnectBuilder withSimpleAuth(@Nullable final Mqtt5SimpleAuth simpleAuth) {
    this.simpleAuth =
        MustNotBeImplementedUtil.checkNullOrNotImplemented(simpleAuth, MqttSimpleAuth.class);
    return this;
  }

  @NotNull
  public Mqtt5ConnectBuilder withEnhancedAuth(
  ...
  public Mqtt5ConnectBuilder withWillPublish(@Nullable final Mqtt5WillPublish willPublish) {
    this.willPublish =
        MustNotBeImplementedUtil.checkNullOrNotImplemented(willPublish, MqttWillPublish.class);
    return this;
  }
