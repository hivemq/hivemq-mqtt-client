 ...
 * @author Silvio Giebl
 */
public class Mqtt5EnhancedAuthImpl implements Mqtt5EnhancedAuth {

    private final Mqtt5UTF8StringImpl method;
    private final ByteBuffer data;

    public Mqtt5EnhancedAuthImpl(@NotNull final Mqtt5UTF8StringImpl method, @Nullable final ByteBuffer data) {
        this.method = method;
        this.data = data;
    }
