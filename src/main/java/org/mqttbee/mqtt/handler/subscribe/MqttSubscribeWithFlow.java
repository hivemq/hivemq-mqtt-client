...
public class MqttSubscribeWithFlow {
  ...
  public MqttSubscribeWithFlow(
      @NotNull final MqttSubscribe subscribe, @NotNull final MqttSubscriptionFlow flow) {
  ...
  @NotNull
  public MqttSubscribeWrapperWithFlow wrap(
      final int packetIdentifier, final int subscriptionIdentifier) {
    return new MqttSubscribeWrapperWithFlow(
        subscribe.wrap(packetIdentifier, subscriptionIdentifier), flow);
  }
