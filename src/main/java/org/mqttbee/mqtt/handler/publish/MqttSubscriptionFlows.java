...
public interface MqttSubscriptionFlows {
  ...
  void subscribe(
      @NotNull final MqttTopicFilterImpl topicFilter, @NotNull MqttSubscriptionFlow flow);
  ...
  boolean findMatching(
      @NotNull MqttTopicImpl topic, final ScNodeList<MqttIncomingPublishFlow> matchingFlows);
}
