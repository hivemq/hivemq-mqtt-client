 ...
 *
 * <p>Only one such event is fired in all cases:
 *
 * <ul>
 *   <li>Server sent a DISCONNECT message
 *   <li>Client sends a DISCONNECT message
 *   <li>Server closed the channel without a DISCONNECT message
 *   <li>Client closes the channel without a DISCONNECT message
 * </ul>
 *
 * @author Silvio Giebl
 */
public class ChannelCloseEvent {
  ...
  /**
   * @return whether the server sent a DISCONNECT message or closed the channel without a DISCONNECT
   *     message.
   */
