...
/**
 * MQTT 5 disconnecter which sends a DISCONNECT messages before closing a channel from the client
 * side. Fires {@link ChannelCloseEvent}s.
 *
 * @author Silvio Giebl
 */
@Singleton
public class Mqtt5Disconnecter implements MqttDisconnecter {
  ...
  public void disconnect(
    ...
    MqttDisconnectUtil.fireChannelCloseEvent(
        channel, new Mqtt5MessageException(disconnect, reasonString), false);
  ...
  public void disconnect(
    ...
    MqttDisconnectUtil.fireChannelCloseEvent(
        channel, new Mqtt5MessageException(disconnect, cause), false);
    MqttDisconnectUtil.disconnectAndClose(channel, disconnect);
  }
