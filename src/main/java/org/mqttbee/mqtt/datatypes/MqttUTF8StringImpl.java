...
public class MqttUTF8StringImpl implements MqttUTF8String {
  ...
  /**
   * Checks whether the given UTF-16 encoded Java string contains characters a UTF-8 encoded String
   * must not according to the MQTT 5 specification.
   *
   * <p>These characters are the null character U+0000 and UTF-16 surrogates.
   *
   ...
   * representation if necessary.
   *
   * <p>This method does not check if this UTF-8 encoded String can not be encoded due to byte count
   ...
   * @throws MqttBinaryDataExceededException if this UTF-8 encoded String can not be encoded due to
