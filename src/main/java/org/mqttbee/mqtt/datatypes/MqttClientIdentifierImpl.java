...
public class MqttClientIdentifierImpl extends MqttUTF8StringImpl implements MqttClientIdentifier {
    ...
    /**
     * Placeholder for a Client Identifier to indicate that the MQTT broker should assign the Client
     * Identifier.
     */
    @NotNull
    ...
    private static final Pattern MUST_BE_ALLOWED_BY_SERVER_PATTERN =
     ...
     * @return the created Client Identifier or null if the byte array does not contain a
     *     well-formed encoded Client Identifier.
     */
    @Nullable
     ...
     * @return the created Client Identifier or null if the given string is not a valid Client
     *     Identifier.
     */
    @Nullable
    ...
    /**
     * Validates and decodes a Client Identifier from the given byte buffer at the current reader
     * index.
     *
     ...
     * @return the created Client Identifier or null if the byte buffer does not contain a
     *     well-formed encoded Client Identifier.
     */
    @Nullable
