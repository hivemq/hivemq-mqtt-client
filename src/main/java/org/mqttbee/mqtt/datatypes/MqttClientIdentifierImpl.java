...
public class MqttClientIdentifierImpl extends MqttUTF8StringImpl implements MqttClientIdentifier {
   ...
   * @return the created Client Identifier or null if the byte array does not contain a well-formed
   ...
   * @return the created Client Identifier or null if the byte buffer does not contain a well-formed
   *     encoded Client Identifier.
   */
  @Nullable
