    ...
    while (in.isReadable()) {
      ...
      switch (propertyIdentifier) {
        ...
        case SERVER_KEEP_ALIVE:
          serverKeepAlive =
              unsignedShortOnlyOnce(
                  serverKeepAlive, KEEP_ALIVE_FROM_CONNECT, "server keep alive", in);
          break;
        ...
        case TOPIC_ALIAS_MAXIMUM:
          ...
          restrictionsPresent |=
              topicAliasMaximum != Mqtt5ConnAckRestrictions.DEFAULT_TOPIC_ALIAS_MAXIMUM;
          break;
        ...
        case WILDCARD_SUBSCRIPTION_AVAILABLE:
          wildCardSubscriptionAvailable =
              booleanOnlyOnce(
                  wildCardSubscriptionAvailablePresent, "wildcard subscription available", in);
        ...
        case SUBSCRIPTION_IDENTIFIER_AVAILABLE:
          subscriptionIdentifierAvailable =
              booleanOnlyOnce(
                  subscriptionIdentifierAvailablePresent, "subscription identifier available", in);
        ...
        case SHARED_SUBSCRIPTION_AVAILABLE:
          sharedSubscriptionAvailable =
              booleanOnlyOnce(
                  sharedSubscriptionAvailablePresent, "shared subscription available", in);
        ...
        case RESPONSE_INFORMATION:
          ...
          responseInformation =
              decodeUTF8StringOnlyOnce(responseInformation, "response information", in);
          break;
