 ...
 * @author Silvio Giebl
 */
public class Mqtt3PubCompEncoder extends MqttMessageEncoderWithMessage<MqttPubCompImpl> {

    public static final MqttMessageEncoderProvider<MqttPubCompImpl> PROVIDER = Mqtt3PubCompEncoder::new;
