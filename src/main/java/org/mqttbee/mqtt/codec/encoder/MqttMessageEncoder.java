...
public interface MqttMessageEncoder {
  ...
  /**
   * Returns the byte count of the given MQTT message respecting the given maximum packet size.
   * Calculation is only performed if necessary.
   *
   * @param maxPacketSize the maximum packet size.
   * @return the encoded length of the MQTT message respecting the maximum packet size or -1 if the
   *     minimal encoded length of the MQTT message is bigger than the maximum packet size.
   */
