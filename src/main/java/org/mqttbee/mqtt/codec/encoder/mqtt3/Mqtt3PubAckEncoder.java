 ...
 * @author Silvio Giebl
 */
public class Mqtt3PubAckEncoder extends MqttMessageEncoderWithMessage<MqttPubAckImpl> {

    public static final MqttMessageEncoderProvider<MqttPubAckImpl> PROVIDER = Mqtt3PubAckEncoder::new;
