 ...
 * @author Silvio Giebl
 */
public abstract class Mqtt5WrappedMessageEncoder<
  ...
  /**
   * Returns the remaining length byte count without the properties of the wrapped MQTT message.
  ...
  /**
   * Returns the property length byte count of the wrapped MQTT message. Calculation is only
  ...
  abstract static class Mqtt5MessageWrapperEncoder< //
          ...
          E extends Mqtt5WrappedMessageEncoder<M, W>>
      extends Mqtt5MessageWithUserPropertiesEncoder<W>
    ...
    @Override
    final MqttUserPropertiesImpl getUserProperties() {
