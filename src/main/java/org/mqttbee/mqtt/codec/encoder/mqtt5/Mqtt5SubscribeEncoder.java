...
public class Mqtt5SubscribeEncoder
    extends Mqtt5WrappedMessageEncoder<MqttSubscribe, MqttSubscribeWrapper> {

  public static final MqttWrappedMessageEncoderProvider<
          MqttSubscribe, MqttSubscribeWrapper, MqttMessageEncoderProvider<MqttSubscribeWrapper>>
  ...
  public static class Mqtt5SubscribeWrapperEncoder
    ...
    private static final MqttMessageWrapperEncoderApplier<
            MqttSubscribeWrapper, MqttSubscribe, Mqtt5SubscribeEncoder>
        APPLIER =
            new ThreadLocalMqttMessageWrapperEncoderApplier<>(Mqtt5SubscribeWrapperEncoder::new);
    ...
    int additionalPropertyLength() {
      return variableByteIntegerPropertyEncodedLength(
          message.getSubscriptionIdentifier(), DEFAULT_NO_SUBSCRIPTION_IDENTIFIER);
    }
