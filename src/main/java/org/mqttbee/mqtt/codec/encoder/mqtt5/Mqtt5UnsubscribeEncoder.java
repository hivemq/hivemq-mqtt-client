...
public class Mqtt5UnsubscribeEncoder
    extends Mqtt5WrappedMessageEncoder<MqttUnsubscribe, MqttUnsubscribeWrapper> {
  ...
  public static class Mqtt5UnsubscribeWrapperEncoder
      extends Mqtt5MessageWrapperEncoder<
          ...
          MqttMessageEncoderProvider<MqttUnsubscribeWrapper>, Mqtt5UnsubscribeEncoder> {

    private static final MqttMessageWrapperEncoderApplier<
            MqttUnsubscribeWrapper, MqttUnsubscribe, Mqtt5UnsubscribeEncoder>
        APPLIER =
            new ThreadLocalMqttMessageWrapperEncoderApplier<>(Mqtt5UnsubscribeWrapperEncoder::new);
    ...
    private void encodePayload(@NotNull final ByteBuf out) {
      final ImmutableList<MqttTopicFilterImpl> topicFilters =
          message.getWrapped().getTopicFilters();
      for (int i = 0; i < topicFilters.size(); i++) {
