...
public class Mqtt3PublishEncoder
    extends Mqtt3WrappedMessageEncoder<MqttPublish, MqttPublishWrapper> {
  ...
  public static final MqttWrappedMessageEncoderProvider<
      ...
      PROVIDER =
          new ThreadLocalMqttWrappedMessageEncoderProvider<>(
              Mqtt3PublishEncoder::new, WRAPPER_PROVIDER);
