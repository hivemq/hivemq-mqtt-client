...
public interface MqttMessageWithUserProperties extends MqttMessage {
    ...
    abstract class MqttMessageWithUserPropertiesImpl implements MqttMessageWithUserProperties {
        ...
        protected MqttMessageWithUserPropertiesImpl(
    ...
    /**
     * Base class for MQTT messages with a Reason Code, an optional Reason String and optional User
     * Properties.
     *
     * @param <R> the type of the Reason Code.
     */
    abstract class MqttMessageWithReasonCode<R extends Mqtt5ReasonCode>
    ...
    /**
     * Base class for MQTT messages with a Packet Identifier, a Reason Code, an optional Reason
     * String and optional User Properties.
     *
     * @param <R> the type of the Reason Code.
     */
    abstract class MqttMessageWithIdAndReasonCode<R extends Mqtt5ReasonCode>
    ...
    /**
     * Base class for MQTT messages with a Packet Identifier, Reason Codes, an optional Reason
     * String and optional User Properties.
     *
     * @param <R> the type of the Reason Codes.
     */
    abstract class MqttMessageWithIdAndReasonCodes<R extends Mqtt5ReasonCode>
            extends MqttMessageWithReasonString {
