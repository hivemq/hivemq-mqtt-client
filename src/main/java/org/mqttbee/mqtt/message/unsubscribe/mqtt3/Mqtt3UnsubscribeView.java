...
public class Mqtt3UnsubscribeView implements Mqtt3Unsubscribe {
  ...
  public static MqttUnsubscribe wrapped(
      @NotNull final ImmutableList<MqttTopicFilterImpl> topicFilters) {
    return new MqttUnsubscribe(
        topicFilters, MqttUserPropertiesImpl.NO_USER_PROPERTIES, Mqtt3UnsubscribeEncoder.PROVIDER);
  }

  public static Mqtt3UnsubscribeView create(
      @NotNull final ImmutableList<MqttTopicFilterImpl> topicFilters) {
