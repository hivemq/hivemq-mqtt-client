...
/**
 * MQTT message with an {@link MqttMessageEncoderApplier} this MQTT message is applied to for
 * encoding.
 *
 ...
 * @author Silvio Giebl
 */
public abstract class MqttMessageWithEncoder<
        M extends MqttMessageWithEncoder<M, P>, P extends MqttMessageEncoderProvider<M>>
