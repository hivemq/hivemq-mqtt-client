...
import org.mqttbee.mqtt.mqtt5.message.disconnect.Mqtt5DisconnectBuilder;
...
public interface Mqtt5RxClient extends Mqtt5Client {
     ...
     *         successfully),</li>
     *         <li>errors with a {@link org.mqttbee.mqtt.mqtt5.exceptions.Mqtt5ConnAckException
     ...
     *         <li>errors with a {@link org.mqttbee.mqtt.mqtt5.exceptions.Mqtt5SubAckException
     ...
     *         Code),</li>
     *         <li>errors with a {@link org.mqttbee.mqtt.mqtt5.exceptions.Mqtt5UnsubAckException
