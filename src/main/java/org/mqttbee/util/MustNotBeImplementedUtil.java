...
public class MustNotBeImplementedUtil {
     ...
     * @throws MustNotBeImplementedException if the object is not instance of the implementation
     *     type.
     */
    @NotNull
    @SuppressWarnings("unchecked")
    public static <S, T extends S> T checkNotImplemented(
            @NotNull final S object, @NotNull final Class<T> type) {
     ...
     * @throws MustNotBeImplementedException if the object is not null and not instance of the
     *     implementation type.
     */
    @Nullable
    public static <S, T extends S> T checkNullOrNotImplemented(
            @Nullable final S object, @NotNull final Class<T> type) {
