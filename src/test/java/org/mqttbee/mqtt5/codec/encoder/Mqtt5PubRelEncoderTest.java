...
class Mqtt5PubRelEncoderTest {
    ...
    void encode_simple() {
        ...
        final Mqtt5PubRelImpl pubRel =
                new Mqtt5PubRelImpl(reasonCode, reasonString, userProperties);
    ...
    void encode_reasonCodeOmittedWhenSuccessWithoutProperties() {
        ...
        final Mqtt5PubRelImpl pubRel =
                new Mqtt5PubRelImpl(SUCCESS, null, ImmutableList.of());
    ...
    void encode_reasonCodes(final Mqtt5PubRelReasonCode reasonCode) {
        ...
        final Mqtt5PubRelImpl pubRel =
                new Mqtt5PubRelImpl(reasonCode, null, ImmutableList.of());
    ...
    void encode_userProperty() {
        ...
        final Mqtt5PubRelImpl pubRel =
                new Mqtt5PubRelImpl(reasonCode, null, userProperties);
    ...
    void encode_maximumPacketSizeExceeded_throwsEncoderException() {
        ...
        final Mqtt5PubRelInternal pubRelInternal =
                new Mqtt5PubRelInternal(pubRel, packetIdentifier);
