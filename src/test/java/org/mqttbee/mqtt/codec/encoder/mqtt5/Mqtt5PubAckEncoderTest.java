...
class Mqtt5PubAckEncoderTest extends AbstractMqtt5EncoderWithUserPropertiesTest {
    ...
    void encode_simple() {
        ...
        final MqttUserPropertiesImpl userProperties =
                MqttUserPropertiesImpl.of(
                        ImmutableList.of(new MqttUserPropertyImpl(user, property)));
    ...
    void encode_omitReasonCodeSuccess() {
        ...
        final MqttPubAck pubAck =
                new MqttPubAck(1, Mqtt5PubAckReasonCode.SUCCESS, null, userProperties);
        encode(expected, pubAck);
    }

    @ParameterizedTest
    @EnumSource(
            value = Mqtt5PubAckReasonCode.class,
            mode = EXCLUDE,
            names = {"SUCCESS"})
    ...
    void encode_omitUserPropertyIfMaxAllowedSizeTooSmall() {
        ...
        final MqttPubAck pubAck =
                new MqttPubAck(
                        1, Mqtt5PubAckReasonCode.NO_MATCHING_SUBSCRIBERS, null, userProperties);
        encode(expected, pubAck);
    }
    ...
    void encode_maximumPacketSizeExceededOnSuccess_omitUserProperties() {
        ...
        final MqttPubAck pubAck =
                new MqttPubAck(
                        ...
                        Mqtt5PubAckReasonCode.SUCCESS,
                        null,
                        maxPacket.getTooManyUserProperties(1));
        encode(expected, pubAck);
    }
    ...
    void encode_multipleUserProperties() {
        ...
        final MqttPubAck pubAck =
                new MqttPubAck(1, Mqtt5PubAckReasonCode.SUCCESS, reasonString, userProperties);
        encode(expected, pubAck);
    }
    ...
    void encode_maximumPacketSize() {
        ...
        final int remainingBytes =
                maxPacket.getRemainingPropertyBytes(); // reason string identifier and length
        // reason string
        ...
        final MqttUserPropertiesImpl maxPossibleUserProperties =
                maxPacket.getMaxPossibleUserProperties();
        maxPossibleUserProperties.encode(expected);

        final MqttPubAck pubAck =
                new MqttPubAck(
                        1, Mqtt5PubAckReasonCode.SUCCESS, reasonString, maxPossibleUserProperties);
    ...
    void encode_maximumPacketSizeExceeded_omitReasonString() {
        ...
        final MqttUTF8StringImpl reasonString =
                getPaddedUtf8String(maxPacket.getRemainingPropertyBytes() + 10);
        final MqttPubAck pubAck =
                new MqttPubAck(
                        1,
                        Mqtt5PubAckReasonCode.SUCCESS,
    ...
    void encode_propertyLengthExceeded_omitUserProperties() {
        ...
        final MqttPubAck pubAck =
                new MqttPubAck(
                        (127 * 256) + 1, Mqtt5PubAckReasonCode.SUCCESS, null, userProperties);
        encode(expected, pubAck);
    }
