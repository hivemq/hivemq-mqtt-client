...
class Mqtt5PublishEncoderTest extends AbstractMqtt5EncoderWithUserPropertiesTest {
  ...
  void encode_allProperties() {
    ...
    final MqttUserPropertyImpl userProperty =
        new MqttUserPropertyImpl(
            requireNonNull(MqttUTF8StringImpl.from("test1")),
    ...
    final MqttPublish publish =
        new MqttPublish(
            ...
            requireNonNull(MqttTopicImpl.from("responseTopic")),
            ByteBuffer.wrap(new byte[] {1, 2, 3, 4, 5}),
            HAS_NOT,
            userProperties,
  ...
  void encode_contentType() {
    ...
    final MqttPublish publish =
        new MqttPublish(
            ...
            MqttPublish.MESSAGE_EXPIRY_INTERVAL_INFINITY,
            Mqtt5PayloadFormatIndicator.UTF_8,
            MqttUTF8StringImpl.from("myContentType"),
            null,
            null,
            HAS_NOT,
            NO_USER_PROPERTIES,
  ...
  void encode_responseTopic() {
    ...
    final MqttPublish publish =
        new MqttPublish(
            ...
            Mqtt5PayloadFormatIndicator.UTF_8,
            null,
            MqttTopicImpl.from("responseTopic"),
            null,
            HAS_NOT,
            NO_USER_PROPERTIES,
            Mqtt5PublishEncoder.PROVIDER);
  ...
  void encode_qos() {
    ...
    final MqttPublish publishQos0 =
        new MqttPublish(
            ...
            Mqtt5PublishEncoder.PROVIDER);
    encode(
        expectedQos0, publishQos0, 7, false, DEFAULT_NO_TOPIC_ALIAS, true, ImmutableIntArray.of());
    ...
    final MqttPublish publishQos1 =
        new MqttPublish(
            ...
            Mqtt5PublishEncoder.PROVIDER);
    encode(
        expectedQos1, publishQos1, 7, false, DEFAULT_NO_TOPIC_ALIAS, true, ImmutableIntArray.of());
    ...
    final MqttPublish publishQos2 =
        new MqttPublish(
            ...
            Mqtt5PublishEncoder.PROVIDER);
    encode(
        expectedQos2, publishQos2, 7, false, DEFAULT_NO_TOPIC_ALIAS, true, ImmutableIntArray.of());
  }
  ...
  void encode_maximumOutgoingPacketSizeExceeded_throwsEncoderException() {
    ...
    final MqttPublishWrapper publishInternal =
        publish.wrap(
            -1, false, MqttPublishWrapper.DEFAULT_NO_TOPIC_ALIAS, false, ImmutableIntArray.of());

    final Throwable exception =
        assertThrows(EncoderException.class, () -> channel.writeOutbound(publishInternal));
  ...
  void encode_propertyLengthExceeded_omitUserProperties() {
    ...
    final int correlationDataLength =
        VARIABLE_BYTE_INTEGER_FOUR_BYTES_MAX_VALUE - 7 - 4 - 2 - 5 - 3;
    ...
    encode(
        expected.array(), publish, -1, false, DEFAULT_NO_TOPIC_ALIAS, true, ImmutableIntArray.of());
    expected.release();
  }
  ...
  private void encode(
    ...
    final MqttPublishWrapper publishInternal =
        publish.wrap(
            packetIdentifier, isDup, DEFAULT_NO_TOPIC_ALIAS, false, subscriptionIdentifiers);
