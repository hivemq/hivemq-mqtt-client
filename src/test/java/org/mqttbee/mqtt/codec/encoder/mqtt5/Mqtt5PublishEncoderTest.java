...
import static org.mqttbee.api.mqtt.mqtt5.message.publish.TopicAliasUsage.MAY;
import static org.mqttbee.api.mqtt.mqtt5.message.publish.TopicAliasUsage.MUST_NOT;
...
class Mqtt5PublishEncoderTest extends AbstractMqtt5EncoderWithUserPropertiesTest {
    ...
    void encode_multipleSubscriptionIdentifiers() {
        ...
        encode(
                ...
                15,
                false,
                DEFAULT_NO_TOPIC_ALIAS,
                true,
                ImmutableIntArray.of(3, 4));
    }
    ...
    void encode_maximumOutgoingPacketSizeExceeded_throwsEncoderException() {
        ...
        assertTrue(
                exception
                        .getMessage()
                        .contains(
                                "packet size exceeded for PUBLISH, minimal possible encoded length: 115, maximum: 100"));
    }
    ...
    void encode_propertyLengthExceeded_omitUserProperties() {
        ...
        final ByteBuffer correlationData =
                ByteBuffer.wrap(expected.array(), 21, correlationDataLength);
