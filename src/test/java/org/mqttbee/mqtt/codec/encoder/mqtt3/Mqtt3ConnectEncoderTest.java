...
class Mqtt3ConnectEncoderTest extends AbstractMqtt5EncoderTest {
    ...
    @Test
    void encode_SUCCESS() {
        final MqttClientIdentifierImpl identifier =
    ...
    void test_SUCCESS_WITH_WILL_WITH_PAHO() throws MqttException {
        ...
        final MqttWillPublish willMessage =
                new MqttWillPublish(
                        Objects.requireNonNull(MqttTopicImpl.from(willTopic)),
                        ByteBuffer.wrap(myLastWill.getBytes()),
                        Objects.requireNonNull(MqttQoS.fromCode(qosWill)),
                        isRetained,
        ...
        final MqttConnect connect =
                Mqtt3ConnectView.delegate(keepAlive, cleanSession, null, willMessage);
        final MqttStatefulConnect connectWrapper =
                connect.createStateful(
                        Objects.requireNonNull(MqttClientIdentifierImpl.from(clientId)), null);
    ...
    void test_PAHO_GETPAYLOAD_METHOD() throws MqttException {
        final org.eclipse.paho.client.mqttv3.internal.wire.MqttConnect pahoConnect =
                new org.eclipse.paho.client.mqttv3.internal.wire.MqttConnect(
                        "TEST", 4, true, 60, null, null, null, null);
