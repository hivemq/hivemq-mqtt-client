...
class Mqtt5PubCompEncoderTest extends AbstractMqtt5EncoderWithUserPropertiesTest {
    ...
    void encode_simple() {
        ...
        final MqttPubComp pubComp =
                new MqttPubComp(5, PACKET_IDENTIFIER_NOT_FOUND, reasonString, userProperties);
    ...
    void encode_reasonCodeOmittedWhenSuccessWithoutProperties() {
        ...
        final MqttPubComp pubComp =
                new MqttPubComp(5, SUCCESS, null, MqttUserPropertiesImpl.NO_USER_PROPERTIES);
    ...
    @ParameterizedTest
    @EnumSource(
            value = Mqtt5PubCompReasonCode.class,
            mode = EXCLUDE,
            names = {"SUCCESS"})
    void encode_reasonCodes(final Mqtt5PubCompReasonCode reasonCode) {
        ...
        final MqttPubComp pubComp =
                new MqttPubComp(
                        0x0605, reasonCode, null, MqttUserPropertiesImpl.NO_USER_PROPERTIES);
    ...
    void encode_reasonString() {
        ...
        final MqttUserPropertiesImpl userProperties = MqttUserPropertiesImpl.NO_USER_PROPERTIES;
        final MqttPubComp pubComp =
                new MqttPubComp(9, PACKET_IDENTIFIER_NOT_FOUND, reasonString, userProperties);
    ...
    void encode_userProperty() {
        ...
        final MqttPubComp pubComp =
                new MqttPubComp(5, PACKET_IDENTIFIER_NOT_FOUND, null, userProperties);
    ...
    void encode_maximumPacketSizeExceeded_throwsEncoderException() {
        ...
        final MqttPubComp pubComp =
                new MqttPubComp(1, SUCCESS, null, MqttUserPropertiesImpl.NO_USER_PROPERTIES);
    ...
    void encode_maximumPacketSizeExceeded_omitReasonString() {
        ...
        final MqttPubComp pubComp =
                new MqttPubComp(
                        ...
                        MqttUTF8StringImpl.from("reason"),
                        userProperties);
        encode(expected, pubComp);
    }
