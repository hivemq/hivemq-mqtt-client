...
class MqttUnsubscribeBuilderTest {
    ...
    void addTopicFilters_error_when_collection_is_empty() {
        ...
        assertThrows(IllegalArgumentException.class, () -> Mqtt5Unsubscribe.builder().addTopicFilters(emptyList));
    }

    @Test
    void addTopicFilters_error_when_varargs_is_empty() {

        assertThrows(IllegalArgumentException.class, () -> Mqtt5Unsubscribe.builder().addTopicFilters());
    }
    ...
    void addTopicFilters_error_when_stream_is_empty() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> Mqtt5Unsubscribe.builder().addTopicFilters(emptyList.stream()));
    }
