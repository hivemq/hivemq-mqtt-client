...
class MqttUnsubscribeBuilderTest {
    ...
    void addTopicFilters_error_when_list_is_empty() {
        ...
        assertThrows(
                IllegalArgumentException.class, () -> Mqtt5Unsubscribe.builder().addTopicFilters(ImmutableList.of()));
    }
    ...
    void addMqttTopicFilterss_error_when_list_is_empty() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> Mqtt5Unsubscribe.builder().addMqttTopicFilters(ImmutableList.of()));
    }
    ...
    void addMqttTopicFilters_correct_use() {
        ...
        final Mqtt5Unsubscribe subscribe = Mqtt5Unsubscribe.builder().addMqttTopicFilters(topics).build();
    ...
    void addMqttTopicFilters_fluent_topic_is_finished_if_addMqttTopicFilters_is_used() {
        ...
        final Mqtt5Unsubscribe subscribe =
                Mqtt5Unsubscribe.builder().topicFilter("fluent").addMqttTopicFilters(topics).build();
    ...
    void addMqttTopicFilters_error_when_topic_object_is_implemented() {
        ...
        assertThrows(
                IllegalArgumentException.class, () -> Mqtt5Unsubscribe.builder().addMqttTopicFilters(topicFilters));
    }
