...
import static com.hivemq.mqtt.client2.mqtt5.message.disconnect.Mqtt5DisconnectReasonCode.MALFORMED_PACKET;
import static com.hivemq.mqtt.client2.mqtt5.message.disconnect.Mqtt5DisconnectReasonCode.PROTOCOL_ERROR;
import static com.hivemq.mqtt.client2.mqtt5.message.unsubscribe.Mqtt5UnsubAckReasonCode.*;
...
class Mqtt5UnsubAckDecoderTest extends AbstractMqtt5DecoderTest {
    ...
    Mqtt5UnsubAckDecoderTest() {
        super(Mqtt5MessageType.UNSUBACK, Mqtt5UnsubAckDecoder.INSTANCE);
    }
