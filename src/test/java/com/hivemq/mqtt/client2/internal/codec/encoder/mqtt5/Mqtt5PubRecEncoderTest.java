...
import static com.hivemq.mqtt.client2.mqtt5.message.publish.Mqtt5PubRecReasonCode.SUCCESS;
...
class Mqtt5PubRecEncoderTest extends AbstractMqtt5EncoderWithUserPropertiesTest {
    ...
    Mqtt5PubRecEncoderTest() {
        super(Mqtt5MessageType.PUBREC, Mqtt5PubRecEncoder.INSTANCE, true);
    }
