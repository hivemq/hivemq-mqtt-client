...
```kotlin
dependencies {
  implementation("com.hivemq:hivemq-mqtt-client:1.4.1")
}
```
...
```kotlin
dependencies {
  implementation(platform("com.hivemq:hivemq-mqtt-client-websocket:1.4.1"))
  implementation(platform("com.hivemq:hivemq-mqtt-client-proxy:1.4.1"))
  implementation(platform("com.hivemq:hivemq-mqtt-client-epoll:1.4.1"))
  implementation("com.hivemq:hivemq-mqtt-client-reactor:1.4.1")
}
```
...
```kotlin
dependencies {
  implementation("com.hivemq:hivemq-mqtt-client-shaded:1.4.1")
}
```
