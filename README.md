...
```groovy
dependencies {
  implementation(platform("com.hivemq:hivemq-mqtt-client-websocket:1.3.6"))
  implementation(platform("com.hivemq:hivemq-mqtt-client-proxy:1.3.6"))
  implementation(platform("com.hivemq:hivemq-mqtt-client-epoll:1.3.6"))
  implementation("com.hivemq:hivemq-mqtt-client-reactor:1.3.6")
}
```
...
```groovy
dependencies {
  implementation("com.hivemq:hivemq-mqtt-client-shaded:1.3.6")
}
```
