...
```kotlin
dependencies {
  implementation(platform("com.hivemq:hivemq-mqtt-client-websocket:1.3.15"))
  implementation(platform("com.hivemq:hivemq-mqtt-client-proxy:1.3.15"))
  implementation(platform("com.hivemq:hivemq-mqtt-client-epoll:1.3.15"))
  implementation("com.hivemq:hivemq-mqtt-client-reactor:1.3.15")
}
```
