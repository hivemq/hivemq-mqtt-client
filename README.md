...
dependencies {
  ...
  implementation(platform("com.hivemq:hivemq-mqtt-client-proxy:1.3.13"))
  implementation(platform("com.hivemq:hivemq-mqtt-client-epoll:1.3.13"))
  implementation("com.hivemq:hivemq-mqtt-client-reactor:1.3.13")
}
```
...
```kotlin
dependencies {
  implementation("com.hivemq:hivemq-mqtt-client-shaded:1.3.13")
}
```
