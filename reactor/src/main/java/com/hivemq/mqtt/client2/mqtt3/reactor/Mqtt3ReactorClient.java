...
package com.hivemq.mqtt.client2.mqtt3.reactor;

import com.hivemq.mqtt.client2.MqttGlobalPublishFilter;
import com.hivemq.mqtt.client2.internal.reactor.mqtt3.Mqtt3ReactorClientView;
import com.hivemq.mqtt.client2.libs.reactor.FluxWithSingle;
import com.hivemq.mqtt.client2.mqtt3.Mqtt3Client;
...
import com.hivemq.mqtt.client2.mqtt3.message.subscribe.Mqtt3SubscribeBuilder;
...
public interface Mqtt3ReactorClient extends Mqtt3Client {
     ...
     *           <li>errors with a {@link com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3ConnAckException
     ...
     *           <li>errors with a {@link com.hivemq.mqtt.client2.mqtt3.exceptions.Mqtt3SubAckException
